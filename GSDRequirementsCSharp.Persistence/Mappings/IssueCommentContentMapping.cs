...
{
    class IssueCommentContentMapping : EntityTypeConfiguration<IssueCommentContent>
    {
        public IssueCommentContentMapping()
        {
            ToTable("IssueCommentContent");
