module Views {
    ...
    export function buildConcreteClass(classData: Models.ClassData) {
    ...
    export function buildInterface(classData: Models.ClassData) {
        var height = (classData.classProperties.length + classData.classMethods.length) * 33;
        height += 40
    ...
    export function buildAbstractClass(classData: Models.ClassData) {
        var height = (classData.classProperties.length + classData.classMethods.length) * 33;
        height += 40
